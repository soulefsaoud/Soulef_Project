...
{   
    ...
    public function new(Request $request, HandleImage $handleImage): Response
    {
        ...
        return $this->render('admin/daily_menu/new.html.twig', [
            'daily_menu' => $dailyMenu,
            'form' => $form->createView()
        ]);
    }

    #[Route('/{id}', name: 'daily_menu_show', methods: ['GET','POST'])]
    public function show(Request $request, DailyMenu $dailyMenu, EntityManagerInterface $em): Response
    {
        ...
        if($form->isSubmitted() && $form->isValid() )
        {
            ...
            $commentaire->setDailyMenu($dailyMenu);
